...
| 📦 **项目** | `js/content.js` | **项目只显示作者真实登记的内容**，不会自动生成假项目。在 `siteContent.projects` 里登记你真实做过的项目。当前已登记唯一真实项目「Chenji Learning Hub」（本站本体）。 |
...
| 📦 **项目** | 项目实验室：只显示你真实登记的项目，按状态分组。当前已登记唯一真实项目「Chenji Learning Hub」（本站本体） |
...
- [x] v0.7.0：**登录页改为「内容维护说明」，删除假登录功能**
- [x] v0.7.1：**登记第一个真实项目「Chenji Learning Hub」（本站本体）**
- [x] v0.7.3：**UI 细节优化**（侧边栏 / 空状态 / 计划标签 / 项目卡片 / 维护页）
- [ ] v0.8.0：写出第一批真实文章
- [ ] v0.9.0：如果需要评论区（如 Giscus）或可嵌入的小游戏
